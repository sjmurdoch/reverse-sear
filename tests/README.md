...
| `lifecycle.spec.js` | closing and reopening: resume, the six-hour stale guard, finishing and its record including the rest clock, starting another, and that the app still works when `localStorage` throws. |
